...
#include <v8.h>
extern v8::Handle<v8::ObjectTemplate> JSlove_sdljoystickCreateClass();
...
namespace love_sdljoystick
{
	...
	bool module_open_v8(void * vm) {
		...
		(*love)->Set(v8::String::New("joystick"), JSlove_sdljoystickCreateClass());
		return true;
	}
	...
	Ball getBall( int index, int ball )
	{
		Ball b;
		b.x = 0;
		b.y = 0;
		...
		SDL_JoystickGetBall(joysticks[index], ball, &b.x, &b.y);
