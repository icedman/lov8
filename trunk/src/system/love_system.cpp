...
#include <v8.h>
extern v8::Handle<v8::ObjectTemplate> JSlove_systemCreateClass();
...
namespace love_system
{
	...
	bool module_open_v8(void * vm) {
		...
		(*love)->Set(v8::String::New("system"), JSlove_systemCreateClass());
		return true;
	}
